...
class CreateAssModel(BasicCreatorModel):
    ...
    maskCamera: bool = SettingsField(title="Export Camera")
    maskLight: bool = SettingsField(title="Export Light")
    maskShape: bool = SettingsField(title="Export Shape")
    maskShader: bool = SettingsField(title="Export Shader")
    maskOverride: bool = SettingsField(title="Export Override")
    maskDriver: bool = SettingsField(title="Export Driver")
    maskFilter: bool = SettingsField(title="Export Filter")
    maskColor_manager: bool = SettingsField(title="Export Color Manager")
    maskOperator: bool = SettingsField(title="Export Operator")
    maskImager: bool = SettingsField(title="Export Imager")
